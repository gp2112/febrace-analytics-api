...
# {'or':[{'and':[{'field':'nu_ano', 'value':2001},
# {'field':'nu_usp', 'value':992}]}, {'value'}]}
...
The Operation Query is any non-leaf tree's node
and can represent "and" and "or" operations.
For example:
    {
...
To parse all the Query Tree, the algorithm uses an
postorder tree transversal algorithm
"""
